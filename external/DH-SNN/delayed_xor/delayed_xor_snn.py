"""
Delayed XOR (delayed_xor_snn.py): 
two signals, 
but the second (test) signal is delayed to the end of the sequence. 
The target only becomes active after the delayed signal window, 
so the model must remember the first signal across a variable delay.
"""
